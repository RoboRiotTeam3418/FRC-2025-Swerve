...
import frc.robot.commands.movePivotCommand;
...
public class RobotContainer {
  ...
  private static CommandJoystick m_primaryJoystick = new CommandJoystick(0);
  ...
  SwerveInputStream driveAngularVelocity = SwerveInputStream.of(drivebase.getSwerveDrive(),
      () -> m_primaryJoystick.getRawAxis(1), // CHECK FUNCTION
      () -> m_primaryJoystick.getRawAxis(0))// CHECK FUNCTION
      .withControllerRotationAxis(() -> m_primaryJoystick.getRawAxis(3))// CHECK FUNCTION
  ...
  SwerveInputStream driveDirectAngle = driveAngularVelocity.copy()
      .withControllerHeadingAxis(m_primaryJoystick::getZ, getNegZ)// checkfunction
      .headingWhile(true);
  ...
  public RobotContainer() {
    ...
    configureBindings();
    m_Pivot.setDefaultCommand(new movePivotCommand(m_Pivot, 30, 5));
